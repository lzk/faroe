...
//enum{
//    IMG_FMT_RAW = ('R'* 0x01000000) | ('A'*0x00010000 ) | ('W'*0x00000100),
//    IMG_FMT_JPG = ('J'* 0x01000000) | ('P'*0x00010000) | ('G'*0x00000100),
//    IMG_FMT_TIF = ('T'* 0x01000000) | ('I'*0x00010000) | ('F'*0x00000100),
//    IMG_FMT_BMP = ('B'* 0x01000000) | ('M'*0x00010000) | ('P'*0x00000100),
//    IMG_FMT_ADF = ('A'* 0x01000000) | ('D'*0x00010000) | ('F'*0x00000100),
//    IMG_FMT_FLB = ('F'* 0x01000000) | ('L'*0x00010000) | ('B'*0x00000100),
//};
