...
enum{
    IMG_FMT_RAW = ('R'&0x000000ff) | (('A'&0x000000ff) << 8) | (('W'&0x000000ff)<< 16),
    IMG_FMT_JPG = ('J'&0x000000ff) | (('P'&0x000000ff) << 8) | (('G'&0x000000ff)<< 16),
    IMG_FMT_TIF = ('T'&0x000000ff) | (('I'&0x000000ff) << 8) | (('F'&0x000000ff)<< 16),
    IMG_FMT_BMP = ('B'&0x000000ff) | (('M'&0x000000ff) << 8) | (('P'&0x000000ff)<< 16),
    IMG_FMT_ADF = ('A'&0x000000ff) | (('D'&0x000000ff) << 8) | (('F'&0x000000ff)<< 16),
    IMG_FMT_FLB = ('F'&0x000000ff) | (('L'&0x000000ff) << 8) | (('B'&0x000000ff)<< 16),
};
